 ...
 */
package com.learning.school.dao.connection;
...
public class DBProvider {
    ...
    private final static DBProvider INSTANCE = new DBProvider();
    RowMapper<Teacher> rmTeacher;
    RowMapper<Student> rmStudent;
    private Connection connection;

    public DBProvider() {
        RowMapperFactory rowMapperFactory = RowMapperFactory.getInstance();
        rmTeacher = rowMapperFactory.getTeacherRowMapper();
        rmStudent = rowMapperFactory.getStudentRowMapper();
        try {
    ...
    public void insertAttestation(Attestation attestation) throws SQLException {
    ...
    public void updateTeacher(Teacher teacher, Class cl) throws SQLException {
        PreparedStatement ps = connection.prepareStatement("UPDATE teacher SET name = ? , phone = ? WHERE id = ?");
    ...
    public void insertClassEvent(String number, int id) throws SQLException {
    ...
    public void insertOrgEvent(int idOrg, int id) throws SQLException {
    ...
    public void updateOrg(Organizator org) throws SQLException {
    ...
    public void insertClass(Class cl) throws SQLException {
        PreparedStatement ps = connection.prepareStatement("INSERT INTO class (number) VALUES (?)");
        ps.setString(1, cl.getNumber());
        ps.executeUpdate();
    }

    public void insertOrg(Organizator org) throws SQLException {
    ...
    public void insertEvent(Event event, ObservableList<Organizator> olOrg, ObservableList<Class> olClass) throws SQLException {
