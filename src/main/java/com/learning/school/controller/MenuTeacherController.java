...
public class MenuTeacherController implements Initializable {
    ...
    void btnAddClicked(MouseEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/learning/school/add_journal.fxml"));
    ...
    void btnChangeClicked(MouseEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/learning/school/edit_journal.fxml"));
            Scene scene = new Scene(root);
            Stage stage = new Stage();
            stage.setScene(scene);
            stage.initStyle(StageStyle.UNDECORATED);
